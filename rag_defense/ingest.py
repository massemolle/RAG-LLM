...
from rag_defense.content_scanner import scan_document, ScanResult, FlagSeverity
...
def run_ingest(
    ...
    try:
        from rag_defense.index_versioning import snapshot_current
        snapshot_current()
        ...
        for root, _, files in os.walk(src):
            for f in files:
                ...
                if not scan_result.is_clean:
                    ...
                    qpath = os.path.join("./safe_index/quarantine", f + ".txt")
    ...
    # Write manifest
    with open("./safe_index/manifest.json", "w", encoding="utf-8") as mf:
